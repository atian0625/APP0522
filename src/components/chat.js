    ...
    return (
        ...
        <View style={styles.container} >
            <View style={styles.Gem} name="side_open">
                <Image style={styles.Gemph} source={require('../img/page5.png')} />
            </View>


            <View style={styles.find}>
                <Image style={styles.find1} source={require('../img/page5-1.png')} />
            </View>
            ...
            <View style={styles.GemphQQ1}>


                <Image style={styles.GemphQQ} source={require('../img/page5chat.png')} />
            </View>
