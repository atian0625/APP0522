  ...
  return (
    ...
    <View style={styles.container} >
      <View style={styles.Gem} name="side_open">
        <Image style={styles.Gemph} source={require('../img/page3-0.jpg')} />



        <TouchableOpacity  style={styles.GemphSS1}>


          <Image style={styles.GemphSS} source={require('../img/page3plus.png')} />
        </TouchableOpacity>

        <TouchableOpacity onPress={() => navigation.navigate('My Book')} style={styles.GemphQQ1}>


          <Image style={styles.GemphQQ} source={require('../img/page3btn.png')} />
        </TouchableOpacity>

        <Image style={styles.Gemphap} source={require('../img/page3ap.png')} />

        <Image style={styles.GemphWW} source={require('../img/page3week.png')} />
      </View>
